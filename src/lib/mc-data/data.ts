...
export const SP_LISTS: SpListDef[] = [
  ...
  },
  {
    ...
    maps: "Projects / umbrellas", itemCount: 1, direction: "two-way",
    ...
    columns: [
      ...
      { name: "Project ID", type: "Single line of text", mc: "id", dir: "pull", required: true, note: "indexed · unique key · adoptable inbound" },
      { name: "Owner", type: "Person", mc: "owner", dir: "push", note: "MC-push-only — never fabricate inbound ownership" },
      { name: "Health", type: "Choice", mc: "health", dir: "two-way", note: "On track/At risk/Off track" },
      { name: "Start Date", type: "Date and time", mc: "started", dir: "two-way" },
      { name: "Target Date", type: "Date and time", mc: "target", dir: "two-way" },
      { name: "Description", type: "Multi line of text", mc: "desc", dir: "two-way" },
      { name: "PRD Link", type: "Hyperlink", mc: "prd", dir: "push", note: "MC-push-only" },
    ],
  },
  {
    ...
    columns: [
      { name: "Title", type: "Single line of text", mc: "name", dir: "two-way", required: true },
      { name: "Initiative ID", type: "Single line of text", mc: "id", dir: "pull", required: true, note: "adoptable inbound" },
      { name: "Project", type: "Lookup → Projects", mc: "project", dir: "two-way" },
      { name: "Owner", type: "Person", mc: "owner", dir: "push", note: "MC-push-only — never fabricate inbound ownership" },
      { name: "Health", type: "Choice", mc: "health", dir: "two-way", note: "On track/At risk/Off track" },
      ...
      { name: "% Complete", type: "Number", mc: "progress", dir: "two-way" },
      { name: "PRD Link", type: "Hyperlink", mc: "prd", dir: "push", note: "MC-push-only" },
    ],
  },
  {
