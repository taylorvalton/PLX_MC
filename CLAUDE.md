# CLAUDE.md â€” Developer Tooling Context
...
```bash
npm install                                # Node deps (web app)
.venv/Scripts/python -m pip install -r requirements.txt  # governance tooling (Windows dev box)
