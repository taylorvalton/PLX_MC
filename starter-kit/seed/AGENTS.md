# AGENTS.md — Canonical Architecture
...
<2-5 sentences: what the system is, its top-level control model, and the one
or two invariants that define it.>

## Runtime Entry Points

<List the real entry points: CLI commands, API endpoints, cron jobs, services.
Keep this exhaustive — agents use it as the map.>

## Architecture

<Component diagram or table. Link to deeper docs in docs/architecture/ rather
than inlining everything here.>
...
|---|---|---|
| <module> | <owner> | Critical / High / Medium / Low |

## Canonical Operations Docs

- `SOUL.md` — mission and non-negotiables
- `AGENTS.md` — architecture, module ownership, runtime policy (this file)
- `TOOLS.md` — tool access, scope, and safety boundaries
- `LESSONS.md` — operational learnings
- `docs/modules/` — module contracts
- `docs/REPO_HYGIENE_SPEC.md` — file placement, naming, archival
