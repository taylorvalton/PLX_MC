...
for f in BrandBoundary.tsx BrandStatusBadge.tsx Kicker.tsx MonoData.tsx PMark.tsx AuthStatusBanner.tsx index.ts README.md; do
...
paths: list[str] = [
    ...
    "src/components/brand/BrandStatusBadge.tsx",
